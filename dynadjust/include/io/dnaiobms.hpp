...
public:
	...
	std::uint64_t create_msr_input_file_meta(vifm_t& vinput_file_meta, input_file_meta_t** input_file_meta);
	void load_bms_file_meta(const std::string& bms_filename, binary_file_meta_t& bms_meta);
	std::uint64_t load_bms_file(const std::string& bms_filename, pvmsr_t vbinary_msr, binary_file_meta_t& bms_meta);
