...
class dna_segment {
   ...
   public:
    ...
    UINT32 stationSolutionCount() const;
    UINT32 maxBlockSize() const;
    UINT32 minBlockSize() const;
    ...
    std::vector<std::string> StartingStations();

    _SEGMENT_STATUS_ GetStatus() const;
   ...
   private:
    ...
    void IdentifyLowestStationAssociation(pvUINT32 vStnList, vUINT32& totalStations, const int currentLevel,
